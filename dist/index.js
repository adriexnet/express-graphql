...
function graphqlHTTP(options) {
  ...
  return function graphqlMiddleware(request, response, nextFunction) {
    ...
    var query = void 0;
    var handleErrorWithExpress = void 0;
    ...
    return getGraphQLParams(request).then(function (graphQLParams) {
      ...
      if (handleErrorWithExpress && result && result.errors && result.errors.length) {
